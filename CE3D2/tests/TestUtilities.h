...
{                                                                                       \
    ...
    for (CE3D2::Models::StorageType<CE3D2::Vector>::size_type k = 0; k < vectors_a.size(); k++)           \
    {                                                                               \
    ...
    for (CE3D2::Models::StorageType<CE3D2::Models::IndexPair>::size_type  k = 0; k < connections_a.size(); k++)   \
    {                                                                               \
